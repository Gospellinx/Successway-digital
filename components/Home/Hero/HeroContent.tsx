  ...
  return (
    <div>
      ...
      <div className="mt-8 flex items-center space-x-4">
        <button data-aos="zoom-in" data-aos-delay="300" className='button__cls bg-[#E78633] hover:bg-[#C26A1F]'>Get Started</button>
        <button data-aos="zoom-in" data-aos-delay="450" className='button__cls bg-[#1A8DCA] hover:bg-[#2151b7]'>Partner with us</button>
      </div>
      {/* Stats */}
